...
RUN mkdir -p /usr/local/texlive/texmf-local/fonts/opentype && \
    ln -s /usr/share/fonts/google-noto-cjk /usr/local/texlive/texmf-local/fonts/opentype/google-noto-cjk
